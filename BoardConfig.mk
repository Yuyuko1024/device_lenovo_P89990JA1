...
TARGET_PREBUILT_KERNEL := $(PREBUILT_PATH)/kernel/kernel
TARGET_PREBUILT_DTB := $(PREBUILT_PATH)/kernel/dtb.img
BOARD_PREBUILT_DTBOIMAGE := $(PREBUILT_PATH)/kernel/dtbo.img
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB)

TARGET_KERNEL_CONFIG := P89990JA1_defconfig
...
BOARD_PREBUILT_VENDORIMAGE := $(PREBUILT_PATH)/vendor/vendor.img
