...
TARGET_PREBUILT_KERNEL := $(LENOVO_PREBUILT)/kernel/Image
TARGET_PREBUILT_DTB := $(LENOVO_PREBUILT)/kernel/dtb.img
BOARD_PREBUILT_DTBOIMAGE := $(LENOVO_PREBUILT)/kernel/dtbo.img
...
BOARD_PREBUILT_VENDORIMAGE := $(LENOVO_PREBUILT)/vendor.img
